...
import { JobSheetDto, jobSheetResDto } from "../../dtos";
    ...
    <div className="space-y-6">
      ...
      <div className="overflow-x-auto pb-2">
        <div className="flex gap-4">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-pink-600 text-white overflow-hidden relative group hover:shadow-xl transition-all min-w-[170px] flex-shrink-0">
      ...
      <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-xl overflow-hidden">
        <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-white to-purple-50/30">
        ...
        <CardContent className="pt-2 px-6 pb-6">
          ...
          <div className="flex flex-col gap-4 mb-6">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search by job ID, brand, or complaints..."
                value={searchTerm}
                onChange={(e) => {
                  setSearchTerm(e.target.value);
                  resetPagination();
                }}
                className="pl-11 h-11 rounded-xl border-gray-200 focus:border-purple-400 focus:ring-purple-400/20 bg-gray-50/50"
              />
            </div>
            ...
            {/* Active Filters */}
            {(filterStatus !== "all" || dateRange.from) && (
          ...
          <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white">
            <div className="overflow-x-auto overflow-y-auto max-h-[600px] relative custom-scrollbar">
              <Table className="w-full" style={{ tableLayout: "fixed" }}>
                <TableHeader className="bg-gradient-to-r from-gray-50 to-purple-50/30 sticky top-0 z-10 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-px after:bg-gray-200">
                  <TableRow className="hover:bg-transparent">
                    <TableHead
                      className="text-gray-700 cursor-pointer group w-[120px] max-w-[120px] whitespace-nowrap overflow-hidden"
                      onClick={() => handleSort("id")}
                      style={{ width: "80px", maxWidth: "120px" }}
                    >
                    ...
                    <TableHead
                      ...
                      style={{ width: "140px", maxWidth: "180px" }}
                    >
                      <div className="flex items-center truncate">
                        Device
                      </div>
                    ...
                    <TableHead
                      ...
                      style={{ width: "100px", maxWidth: "130px" }}
                    >
                      <div className="flex items-center truncate">
                        Created On
                ...
                <TableBody>
                  {jobSheetRes.total === 0 ? (
                    ...
                    jobSheets.map((job) => (
                      ...
                      >
                        <TableCell
                          className="text-purple-700 whitespace-nowrap overflow-hidden"
                          style={{
                            width: "120px",
                            maxWidth: "120px",
                            minWidth: "120px",
                        ...
                        >
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-8 px-3 hover:bg-purple-100 hover:text-purple-700 rounded-lg"
                            onClick={() => {
            ...
            <div className="bg-gradient-to-t from-purple-50/50 to-transparent py-2.5 px-4 flex items-center justify-center gap-2 text-xs text-gray-400 border-t border-gray-100">
              <svg
