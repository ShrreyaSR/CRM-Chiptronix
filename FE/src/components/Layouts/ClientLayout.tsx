...
export default function ClientLayout() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-pink-50/30 flex">
      <aside
          ...
          <div className="p-4 border-t border-gray-200/50">
            <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-gray-50 to-purple-50/50 mb-3">
              <Avatar className="w-10 h-10 border-2 border-purple-200">
                <AvatarFallback className="bg-gradient-to-br from-purple-600 to-pink-700 text-white">
                  {getUserInitials()}
                </AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                <p className="text-sm text-gray-900 truncate">{user.name || "Client"}</p>
