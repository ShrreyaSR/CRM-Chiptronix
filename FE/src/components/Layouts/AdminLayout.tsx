...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { id: "add-jobsheet", label: "Add Job Sheet", icon: Layers, path: "/admin/add-jobsheet" },
    { id: "technician", label: "Technicians", icon: UserCog, path: "/admin/technician" },
    { id: "client", label: "Clients", icon: Users, path: "/admin/client" },
    { id: "master-data", label: "Master Data", icon: Layers, path: "/admin/master-data" },
    { id: "sales-person", label: "Sales Person", icon: UserCog, path: "/admin/sales-person" },
  ];
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/30 flex">
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-green-600 via-teal-600 to-cyan-600"></div>

        <div className="p-3 flex items-center justify-between border-b border-gray-200/50">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-green-600 to-teal-700 rounded-2xl blur opacity-50 group-hover:opacity-75 transition-opacity"></div>
              <div className="relative bg-gradient-to-br from-green-600 to-teal-700 w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <TooltipProvider delayDuration={0}>
            {menuItems.map((item) => {
              ...
              const buttonClasses = cn(
                ...
                isActive
                  ? "bg-gradient-to-r from-green-600 to-teal-700 text-white shadow-lg shadow-green-500/30"
